...
trait Setting_Section_ReComp {
	...
	public function render_recompression() {
		...
		echo         '</label>';
		echo         '<label>';
		echo           '<input type="checkbox" data-target-condition="type" data-key="auto-avif"'. esc_attr( isset( $target['type']['auto-avif'] ) && ! $target['type']['auto-avif'] ? '' : ' checked' ). '>';
		echo           '<span>Auto Generated AVIF</span>';
		echo         '</label>';
		echo       '</div>';
		echo     '</div>';
		echo     '<div class="target-conditions-wrapper">';
