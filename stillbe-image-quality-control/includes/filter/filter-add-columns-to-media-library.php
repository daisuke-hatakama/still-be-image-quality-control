...
add_filter( 'manage_media_columns', function( $columns ) {
	...
	// Optimization Status
	$columns['optimization_status'] = __( 'Optimization Status', 'still-be-image-quality-control' );
...
add_action( 'admin_enqueue_scripts', function( $hook_suffix ) {
	...
	wp_add_inline_script(
		...
		'window.$stillbe.admin.restBase = "'. esc_js( Rest_Api::REST_NAMESPACE ). '";'.
		'window.$stillbe.admin.restTimeoutSec = '. absint( STILLBE_IQ_WPCRON_MAX_EXECUTION_TIME ). ';'.
